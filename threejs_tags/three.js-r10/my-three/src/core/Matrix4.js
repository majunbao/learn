...
THREE.Matrix4.prototype = {
    ...
    lookAt: function (eye, center, up) {
        var z = new THREE.Vector3().sub(eye, center).normalize();
        var x = new THREE.Vector3().cross(up, z).normalize();
        var y = new THREE.Vector3().cross(z, x).normalize().negate();
    ...
    transform: function (v) {
        ...
        var vw = v.w !== undefined ? v.w : 1.0;

        var x = this.n11 * vx + this.n12 * vy + this.n13 * vz + this.n14 * vw;
        var y = this.n21 * vx + this.n22 * vy + this.n23 * vz + this.n24 * vw;
        var z = this.n31 * vx + this.n32 * vy + this.n33 * vz + this.n34 * vw;
        var w = this.n41 * vx + this.n42 * vy + this.n43 * vz + this.n44 * vw;
    ...
    crossVector: function (a) {
        return new THREE.Vector4(
            this.n11 * a.x + this.n12 * a.y + this.n13 * a.z + this.n14 * a.w,
            this.n21 * a.x + this.n22 * a.y + this.n23 * a.z + this.n24 * a.w,
            this.n31 * a.x + this.n32 * a.y + this.n33 * a.z + this.n34 * a.w,
            a.w !== undefined ? this.n41 * a.x + this.n42 * a.y + this.n43 * a.z + this.n44 * a.w : 1
        );
    },
...
THREE.Matrix4.rotationXMatrix = function (theta) {
    var m = new THREE.Matrix4();
    m.n22 = m.n33 = Math.cos(theta);
    m.n32 = Math.sin(theta);
    m.n23 = -m.n32;
    return m;
};
...
THREE.Matrix4.rotationYMatrix = function (theta) {
    var m = new THREE.Matrix4();
    m.n11 = m.n33 = Math.cos(theta);
    m.n13 = Math.sin(theta);
    m.n31 = -m.n13;
    return m;
};
...
THREE.Matrix4.rotationZMatrix = function (theta) {
    var m = new THREE.Matrix4();
    m.n11 = m.n22 = Math.cos(theta);
    m.n21 = Math.sin(theta);
    m.n12 = -m.n21;
    return m;
};
